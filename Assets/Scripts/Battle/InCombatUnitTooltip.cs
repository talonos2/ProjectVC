...
/// <summary>
/// Attach this component to a GameObject with a collider to put a combat tooltip on it.
/// 
/// This is a copy and modification of the "SimpleTooltip" class in the SimpleTooltip package.
/// 
/// TODO: If the gameobject with this component attached dies, hide the tooltip.
/// </summary>

[DisallowMultipleComponent]
public class InCombatUnitTooltip : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    private InCombatUnitTooltipController tooltipController;
    ...
    /// <summary>
    /// A pointer to the soldier located on this GameObject so we don't need to call GetComponent.
    /// </summary>
    ...
    private void Awake()
    {
        ...
        tooltipController = FindObjectOfType<InCombatUnitTooltipController>();
    ...
    /// <summary>
    /// Loads up the CombatTooltip singleton.
    /// </summary>
    /// <returns></returns>
    public static InCombatUnitTooltipController AddTooltipPrefabToScene()
    {
        return Instantiate(Resources.Load<GameObject>("InCombatUnitTooltip")).GetComponentInChildren<InCombatUnitTooltipController>();
    }
    ...
    public void ShowTooltip()
    {
        showing = true;
        cursorInside = true;
        tooltipController.SetTooltipData(soldier);
